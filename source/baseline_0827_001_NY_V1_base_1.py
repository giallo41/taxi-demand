...
MODEL_VER = '0827_001_NY_V1_base_1_re_re_p50'
...
early_stopping = keras.callbacks.EarlyStopping(monitor='val_invlog_mape_tr10', min_delta=0, patience=50, verbose=0, mode='min')
